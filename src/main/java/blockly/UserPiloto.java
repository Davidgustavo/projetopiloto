...
public static Var Executar() throws Exception {
 return new Callable<Var>() {
   ...
   public Var call() throws Exception {
    ...
    login_user = cronapi.database.Operations.query(Var.valueOf("app.entity.User"),Var.valueOf("select u from User u where u.email = :email"),Var.valueOf("email",item));
    cronapi.util.Operations.callClientFunction(Var.valueOf("cronapi.screen.changeValueOfField"), Var.valueOf("vars.name"), cronapi.object.Operations.getObjectField(login_user, Var.valueOf("name")));
    cronapi.util.Operations.callClientFunction(Var.valueOf("cronapi.screen.changeValueOfField"), Var.valueOf("vars.email"), cronapi.object.Operations.getObjectField(login_user, Var.valueOf("email")));
    ...
    cronapi.util.Operations.callClientFunction(Var.valueOf("cronapi.screen.changeValueOfField"), Var.valueOf("vars.tipo_sanguineo"), cronapi.object.Operations.getObjectField(login_user, Var.valueOf("tipo_sanguineo")));
